...
namespace Delobytes.App.Backend.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260917000000_DropRawMaterialRates")]
    partial class DropRawMaterialRates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.PackagingComponentPrice", b =>
            {
                ...
                b.HasIndex("PackagingComponentId", "ValidFrom");
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.ProductWorkRate", b =>
            {
                ...
                b.HasIndex("ProductId", "WorkRateId")
                    .IsUnique();
