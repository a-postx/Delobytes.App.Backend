...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.PackagingComponentPrice", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid");
                ...
                b.HasIndex("TenantId", "PackagingComponentId", "ValidFrom")
                    .HasDatabaseName("IX_PackagingComponentPrices_TenantId_ComponentId_ValidFrom");

                b.ToTable("PackagingComponentPrices", "catalog");
            });
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.PackagingComponentPrice", b =>
            {
                ...
                b.HasOne("Delobytes.App.Backend.Catalog.Domain.Entities.Supplier", "Supplier")
                    .WithMany("PackagingComponentPrices")
