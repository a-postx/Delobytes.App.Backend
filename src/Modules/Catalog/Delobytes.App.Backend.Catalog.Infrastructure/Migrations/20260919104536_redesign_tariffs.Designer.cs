...
namespace Delobytes.App.Backend.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260919104536_redesign_tariffs")]
    partial class redesign_tariffs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.CostType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.MarginCalculationSnapshot", b =>
                {
                    ...
                    b.Property<decimal>("ChannelCostTotal")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.Property<decimal>("MaterialLogisticsCost")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.ProductBarcode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProductBarcodes", "catalog");
                });

            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.ProductChannelCost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductId", "ChannelId", "CostTypeId")
                        .IsUnique();

                    b.ToTable("ProductChannelCosts", "catalog");
                });
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.ProductChannelCost", b =>
                {
                    ...
                    b.HasOne("Delobytes.App.Backend.Catalog.Domain.Entities.CostType", "CostType")
                        .WithMany("ProductChannelCosts")
            ...
            modelBuilder.Entity("Delobytes.App.Backend.Catalog.Domain.Entities.CostType", b =>
                {
                    b.Navigation("ProductChannelCosts");
                });
