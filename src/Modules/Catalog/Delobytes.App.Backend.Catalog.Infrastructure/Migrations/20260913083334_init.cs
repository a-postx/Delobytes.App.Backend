...
namespace Delobytes.App.Backend.Catalog.Infrastructure.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComponentPrices_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComponentPrices_IsActive",
                schema: "catalog",
                table: "ComponentPrices",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ComponentPrices_SupplierId",
                schema: "catalog",
                table: "ComponentPrices",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_ComponentPrices_TenantId",
                schema: "catalog",
                table: "ComponentPrices",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ComponentPrices_TenantId_ComponentId_ValidFrom",
                schema: "catalog",
                table: "ComponentPrices",
                columns: new[] { "TenantId", "ComponentId", "ValidFrom" });
