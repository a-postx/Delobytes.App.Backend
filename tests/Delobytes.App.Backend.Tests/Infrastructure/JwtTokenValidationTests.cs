...
/// All tests use a self-generated RSA key pair.
/// </summary>
public sealed class JwtTokenValidationTests : IDisposable
{
    private const string TestIssuer = "https://test-tenant.yandex.ru/";
    private const string TestAudience = "https://api.delobytes.io";
    private const string TestSubject = "user_abc123";
    ...
    {
        // Arrange
        string token = CreateValidToken(issuer: "https://evil-tenant.yandex.ru/");
